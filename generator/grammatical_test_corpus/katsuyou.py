...
#text1 = 主節、text2 = 従属節
def marge_heiritsu2(text1, text2, syusyoku, touten = 0):
    #sentence = text1+' '+text2+' 。'
    #print(unk)
    #print(sentence)
    #sentence = setsuzoku(sentence, ta, unk)
    #sentence = setsuzoku(sentence, te, 0)
    #入力文をそれぞれリスト化
    texts1 = text1.split()
    texts2 = text2.split()
    sentence = ''
...
if __name__ == '__main__':
    ...
    print()
    sentence1 = marge_heiritsu2(text1,text2, syusyoku, touten = 1)
    ...
    print('連体節の複文： ', sentence2)
    sentence3 = marge_noun(text1,text2, syusyoku, kaku, touten = 1)
    print('名詞節の複文： ', sentence3)
    print()
